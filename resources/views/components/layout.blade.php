...
<body class="bg-gray-50 text-gray-800 flex flex-col min-h-screen">
    ...
    <header class="fixed w-full z-50 top-0 shadow-sm transition-all duration-300 bg-white group/header" 
        ...
        <div class="bg-pln-dark text-white py-2.5 relative z-50 border-b border-white/10 transition-all duration-300"
             :class="{ 'hidden': scrolled }">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex justify-between items-center">
                
                <div class="hidden md:flex items-center space-x-6 text-xs font-medium text-white/80">
                    <div class="flex items-center gap-2">
                        <svg class="w-4 h-4 text-pln-yellow" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"></path></svg>
                        <span>(0542) 8703981 - (0542) 8506674</span>
                    </div>
                    <div class="flex items-center gap-2">
                        <svg class="w-4 h-4 text-pln-yellow" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"></path></svg>
                        <a href="mailto:plnnd@plnnusadaya.co.id" class="hover:text-pln-yellow transition">plnnd@plnnusadaya.co.id</a>
                    </div>
                </div>

                <div class="flex items-center gap-4 w-full md:w-auto justify-center md:justify-end">
                    <span class="text-xs font-semibold text-white/70 hidden md:inline">Ikuti Kami:</span>
                    
                    <a href="https://instagram.com/officialplnnd" target="_blank" class="bg-white/10 p-1.5 rounded-full hover:bg-pln-yellow hover:text-pln-dark transition duration-300" title="Instagram">
                    ...
                    <a href="https://x.com/plnnusadaya" target="_blank" class="bg-white/10 p-1.5 rounded-full hover:bg-pln-yellow hover:text-pln-dark transition duration-300" title="X">
                        <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
                    </a>

                    <a href="https://www.facebook.com/plnnusadaya" target="_blank" class="bg-white/10 p-1.5 rounded-full hover:bg-pln-yellow hover:text-pln-dark transition duration-300" title="Facebook">
                        <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
                    </a>
                    
                    <a href="https://www.tiktok.com/@pln_nusadaya" target="_blank" class="bg-white/10 p-1.5 rounded-full hover:bg-pln-yellow hover:text-pln-dark transition duration-300" title="TikTok">
                    ...
                    <a href="https://www.youtube.com/@officialplnnd" target="_blank" class="bg-white/10 p-1.5 rounded-full hover:bg-pln-yellow hover:text-pln-dark transition duration-300" title="YouTube">
                        <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"/></svg>
                    </a>
                    
                    <a href="https://www.linkedin.com/company/pln-nusa-daya/" target="_blank" class="bg-white/10 p-1.5 rounded-full hover:bg-pln-yellow hover:text-pln-dark transition duration-300" title="LinkedIn">
    ...
    <footer class="relative bg-gradient-to-b from-pln-dark to-gray-900 text-white pt-16 pb-8 overflow-hidden border-t-4 border-pln-yellow mt-20">

<x-layout>
    ...
    <section class="relative bg-blue-900 pt-32 pb-20 px-4 text-center text-white overflow-hidden">
        <div class="absolute inset-0 z-0 opacity-20">
             <img src="{{ $imageUrl }}" alt="" class="w-full h-full object-cover blur-sm">
        </div>
    ...
    <section class="py-16 bg-white">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="rounded-2xl overflow-hidden shadow-xl mb-10 h-[400px] md:h-[500px] bg-gray-100 flex justify-center items-center">
                <img src="{{ $imageUrl }}" 
                     alt="{{ $post->title }}" 
                     class="w-full h-full {{ $post->image ? 'object-cover' : 'object-contain p-12 opacity-50' }}">
            </div>
            ...
            <div class="mt-12 pt-8 border-t border-gray-100 flex justify-between items-center">
                <a href="{{ route('news.index') }}" class="inline-flex items-center text-teal-600 font-bold hover:text-teal-800 transition">

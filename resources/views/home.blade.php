<x-layout>
    ...
    x-init="startTimer()"
    class="relative w-full h-[90vh] min-h-[600px] flex flex-col bg-pln-dark mt-[-80px] pt-20"> 
        <div class="absolute inset-0 z-0 overflow-hidden">
            ...
            <div class="absolute inset-0 bg-gradient-to-r from-pln-dark/90 via-pln-dark/60 to-transparent"></div>
        </div>
        ...
        <div class="relative z-10 flex-grow flex flex-col justify-end pb-12">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full flex flex-col md:flex-row md:justify-between md:items-end gap-6">
                ...
                <div>
                    <h4 class="text-white/80 text-xl font-light mb-1"><span class="text-pln-yellow font-bold">#</span>PoweringTheFuture</h4>
                    <h1 class="text-white text-5xl md:text-6xl font-extrabold tracking-tight">
                        Powering Your <br>
                        <span class="text-pln-yellow" x-text="slides[active].title"></span>
                    </h1>
                </div>

                <div class="flex items-center gap-6 pb-2">
                    <div class="text-white font-bold text-xl">
                        <span class="text-pln-yellow text-3xl" x-text="active + 1"></span> 
                        <span class="text-white/60 text-lg">/ <span x-text="slides.length"></span></span>
                    </div>
                    <div class="flex gap-3">
                        <button @click="prev()" class="w-12 h-12 rounded-full bg-white/10 backdrop-blur-md border border-white/20 text-white flex items-center justify-center hover:bg-pln-yellow hover:border-pln-yellow hover:text-pln-dark hover:scale-105 transition-all duration-300 shadow-lg">
                        ...
                        <button @click="next()" class="w-12 h-12 rounded-full bg-white/10 backdrop-blur-md border border-white/20 text-white flex items-center justify-center hover:bg-pln-yellow hover:border-pln-yellow hover:text-pln-dark hover:scale-105 transition-all duration-300 shadow-lg">
            ...
            <div class="hidden lg:flex flex-col justify-start w-80 bg-gray-50 p-8 pt-10 lg:p-12 pb-24 lg:pb-32 border-l border-gray-200 lg:rounded-tl-none">
                ...
                <div class="flex flex-col gap-3">
                    <a href="{{ route('about') }}" class="text-gray-600 hover:text-pln-primary font-medium flex justify-between items-center group transition">
                        Profil Perusahaan
                        <span class="text-gray-300 group-hover:text-pln-primary transform group-hover:translate-x-1 transition">&rarr;</span>
                    </a>
                    <hr class="border-gray-200">
                    <a href="{{ route('services') }}" class="text-gray-600 hover:text-pln-primary font-medium flex justify-between items-center group transition">
                        Layanan Bisnis
                        <span class="text-gray-300 group-hover:text-pln-primary transform group-hover:translate-x-1 transition">&rarr;</span>
                    </a>
                    <hr class="border-gray-200">
                    <a href="{{ route('governance') }}" class="text-gray-600 hover:text-pln-primary font-medium flex justify-between items-center group transition">
                        Tata Kelola (GCG)
                        <span class="text-gray-300 group-hover:text-pln-primary transform group-hover:translate-x-1 transition">&rarr;</span>
                    </a>
                </div>
        ...
        <div class="bg-white rounded-2xl shadow-[0_20px_50px_rgba(0,0,0,0.1)] py-10 px-8 border border-gray-100 backdrop-blur-xl">
            <div class="grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-12 divide-y md:divide-y-0 md:divide-x divide-gray-100">
                <div class="text-center pt-4 md:pt-0">
                    <p class="text-4xl md:text-5xl font-extrabold text-pln-dark mb-1">22<span class="text-pln-primary">+</span></p>
                    <p class="text-xs md:text-sm font-bold text-gray-400 uppercase tracking-widest">Tahun Pengalaman</p>
                </div>
                <div class="text-center pt-4 md:pt-0">
                    <p class="text-4xl md:text-5xl font-extrabold text-pln-dark mb-1">335<span class="text-pln-primary">+</span></p>
                    <p class="text-xs md:text-sm font-bold text-gray-400 uppercase tracking-widest">Proyek Dikelola</p>
                </div>
                <div class="text-center pt-4 md:pt-0">
                    <p class="text-4xl md:text-5xl font-extrabold text-pln-dark mb-1">5<span class="text-pln-primary"></span></p>
                ...
                <div class="text-center pt-4 md:pt-0 flex flex-col justify-center">
                    <div class="flex items-center justify-center gap-2 mb-1">
                        <span class="relative flex h-4 w-4">
                          <span class="animate-ping absolute inline-flex h-full w-full rounded-full bg-pln-primary opacity-75"></span>
                          <span class="relative inline-flex rounded-full h-4 w-4 bg-pln-primary"></span>
                        </span>
                        <p class="text-4xl md:text-5xl font-extrabold text-pln-dark">24<span class="text-pln-primary">/7</span></p>
                    </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10"
            ...
            <div class="flex flex-col lg:flex-row gap-16 items-start">
                ...
                <div class="lg:w-1/2 flex flex-col">
                    <span class="inline-block text-pln-primary font-bold tracking-widest uppercase text-sm mb-4">PLN Nusa Daya Untuk Indonesia</span>
                    <h2 class="text-4xl md:text-5xl font-extrabold text-pln-dark mb-6 leading-tight">Membangun Kedaulatan Energi Bangsa</h2>
                    ...
                    <div class="flex flex-col space-y-2 mt-4 relative">
                        ...
                        <template x-for="item in items" :key="item.id">
                            <div class="relative pl-6 cursor-pointer group" @click="activeTab = item.id">
                                ...
                                <div class="absolute left-0 top-0 w-1 bg-pln-primary transition-all duration-500 rounded-full"
                                ...
                                <h3 class="text-2xl font-bold transition-all duration-300 py-3"
                                    :class="activeTab === item.id ? 'text-pln-dark' : 'text-gray-400 group-hover:text-pln-dark/70'"
                                ...
                                <div x-show="activeTab === item.id" 
                                    ...
                                    <a href="{{ route('about') }}" class="inline-flex items-center text-pln-primary font-bold hover:text-pln-dark transition-colors pb-6 text-sm">
                    ...
                    <template x-for="item in items" :key="'img-'+item.id">
                        <div class="absolute inset-0 transition-all duration-700 ease-[cubic-bezier(0.4,0,0.2,1)]"
                            ...
                            <div class="w-full h-full rounded-3xl overflow-hidden shadow-[0_20px_50px_rgba(0,0,0,0.2)] border-8 border-white bg-gray-100">
                                ...
                                <div class="absolute inset-0 bg-pln-dark/10 mix-blend-overlay"></div>
                            </div>
    ...
    <section class="py-28 bg-gray-50 relative border-t border-gray-200">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            <div class="text-center max-w-3xl mx-auto mb-16">
                <span class="inline-flex items-center justify-center text-pln-primary font-bold tracking-widest uppercase text-sm mb-4">
                    <span class="w-8 h-0.5 bg-pln-primary mr-3"></span> Lini Bisnis Utama <span class="w-8 h-0.5 bg-pln-primary ml-3"></span>
                </span>
                <h2 class="text-4xl md:text-5xl font-extrabold text-pln-dark mb-6">Solusi Terintegrasi</h2>
            ...
            <div class="text-center mt-12">
                <a href="{{ route('services') }}" class="inline-flex items-center bg-pln-dark text-white px-8 py-4 rounded-full font-bold hover:bg-pln-primary transition shadow-lg group">
    ...
    <section class="py-28 bg-white overflow-hidden">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-16">
                <span class="text-pln-primary font-bold tracking-widest uppercase text-sm mb-2 block">Jangkauan Luas</span>
                <h2 class="text-4xl md:text-5xl font-extrabold text-pln-dark mb-6">Menghubungkan Nusantara</h2>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
                ...
                <div class="lg:col-span-4 order-2 lg:order-1">
                    <div class="bg-white p-8 rounded-3xl shadow-[0_10px_40px_rgba(0,0,0,0.08)] border border-gray-100 relative overflow-hidden group hover:border-pln-primary/30 transition-colors duration-300">
                        <div class="absolute top-0 right-0 w-32 h-32 bg-pln-primary/10 rounded-bl-full -mr-10 -mt-10 transition-transform group-hover:scale-110"></div>
                        
                        <h4 class="font-bold text-pln-dark text-2xl mb-8 border-b-4 border-pln-primary pb-3 inline-block relative z-10">Area Operasional</h4>
                        ...
                        <ul class="space-y-6 relative z-10">
                            <li class="flex items-start gap-4 group/item">
                                ...
                                <div>
                                    <span class="block text-pln-dark font-bold text-lg group-hover/item:text-pln-primary transition-colors">Kalimantan</span>
                            ...
                            <li class="flex items-start gap-4 group/item">
                                ...
                                <div>
                                    <span class="block text-pln-dark font-bold text-lg group-hover/item:text-pln-primary transition-colors">Sulawesi</span>
                            ...
                            <li class="flex items-start gap-4 group/item">
                                ...
                                <div>
                                    <span class="block text-pln-dark font-bold text-lg group-hover/item:text-pln-primary transition-colors">Nusa Tenggara</span>
                            ...
                            <li class="flex items-start gap-4 group/item">
                                ...
                                <div>
                                    <span class="block text-pln-dark font-bold text-lg group-hover/item:text-pln-primary transition-colors">Maluku & Papua</span>
                ...
                <div class="lg:col-span-8 order-1 lg:order-2">
                    <div class="relative rounded-3xl overflow-hidden shadow-2xl border-4 border-white ring-1 ring-gray-100 transform hover:scale-[1.01] transition duration-700 bg-pln-blue/5">
                        ...
                        <div class="absolute inset-0 bg-gradient-to-t from-pln-dark/10 to-transparent pointer-events-none z-20"></div>
                    </div>
                </div>
    ...
    <section class="py-28 bg-gray-50 border-t border-gray-200">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex flex-col md:flex-row justify-between items-end mb-16 gap-6">
                <div>
                    <h2 class="text-4xl md:text-5xl font-extrabold text-pln-dark mb-4">Media & Informasi</h2>
                    <p class="text-lg text-gray-600">Berita dan kabar terbaru dari aktivitas perusahaan kami.</p>
                </div>
                <a href="{{ route('news.index') }}" class="inline-flex items-center font-bold text-pln-dark hover:text-pln-primary transition-colors group px-6 py-3 border-2 border-pln-dark hover:border-pln-primary rounded-full">
                    Lihat Semua Berita
                    <svg class="w-5 h-5 ml-2 transform group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M17 8l4 4m0 0l-4 4m4-4H3"></path></svg>
                </a>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-10">
                @forelse($posts as $post)
                    ...
                    <article class="group cursor-pointer flex flex-col h-full bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-500 border border-gray-100 hover:-translate-y-1">
                        <div class="overflow-hidden relative h-64 w-full bg-gray-100 flex justify-center items-center">
                            <img src="{{ $imageUrl }}" alt="{{ $post->title }}" class="w-full h-full {{ $post->image ? 'object-cover' : 'object-contain p-8 opacity-50' }} transform group-hover:scale-110 transition duration-700 ease-in-out">
                        ...
                        <div class="p-8 flex flex-col flex-grow">
                            ...
                            <h3 class="text-2xl font-bold text-pln-dark mb-4 group-hover:text-pln-primary transition-colors leading-snug">
                            ...
                            <div class="mt-auto pt-4 border-t border-gray-100 flex items-center text-pln-primary font-bold text-sm">
                                BACA SELENGKAPNYA 
